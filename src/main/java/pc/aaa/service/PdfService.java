...
//                System.out.println(putRet.key);
    ...
    public void testExportWord(String resumeid,String template) throws Exception {

        Pdf ab=pdfRepository.findByResumeidAndTemplate(resumeid,template);
        String templeteimgurl=ab.getQiniuname();

        resumeService.uptemplete(resumeid,templeteimgurl,template);
//        Resume resume = this.resumeService.userresume(resumeid);
//
