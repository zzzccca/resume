...
public class WeixinidService {
    ...
    public Object decodeUserInfo(String encryptedData, String iv, String code) {

        Map map = new HashMap();

        //小程序唯一标识   (在微信小程序管理后台获取)
        String wxspAppid = "wx80684f34298ce2d7";
        //小程序的 app secret (在微信小程序管理后台获取)
        String wxspSecret = "c824f6a999052692d158e16c3d3c8482";
        //授权（必填）
